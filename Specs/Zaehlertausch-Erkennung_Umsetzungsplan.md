...
| [ ] | 10. Specs/Doku nachziehen | `MQTT-Integration.md` (FR-3 Payload-Vertrag), `Pi-Gateway-Software.md` (Config-Beispiel + AK, „byte-genau" lockern), `docs/Zaehlertausch.md` (Checkliste) – siehe Tabellen oben |
