...
/**
 * Sichert ausschliesslich die Actuator-Endpoints mit Basic Auth:
 * health/info/prometheus bleiben oeffentlich (Prometheus-Scrape), alle uebrigen
 * (env, loggers, heapdump, ...) erfordern Basic Auth.
 * <p>
 * Das Angular-Frontend (statische Ressourcen, /assets/config.json) hat bewusst
 * keine SecurityFilterChain und wird wie bisher ohne Authentifizierung ausgeliefert
 * (Login erfolgt clientseitig via Keycloak).
 */
@Configuration
@EnableWebSecurity
